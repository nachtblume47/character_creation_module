...
def attack(char_name: str, char_class: str) -> str:
    """Attack the enemy and return result depending.
    of character type.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Defend function returning the amount of blocked damage.
...
def special(char_name: str, char_class: str) -> str:
    """Use of the special ability and return string.
    depending of the character type.
    """
    if char_class == 'warrior':
